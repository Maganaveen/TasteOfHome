       ...
       <section className="welcome-section">
        ...
        <section className="featured-categories">
          ...
          <div className="category-grid">
            <div className="category-card">
              <img src="/TasteOfHome/maindish.jpg" alt="Main Dishes" />
            ...
            <div className="category-card">
              <img src="/TasteOfHome/appetizers.jpg" alt="Appetizers" />
              <div className="category-info">
                <h3>Appetizers</h3>
                <p>
            ...
            <div className="category-card">
              <img src="/TasteOfHome/dessert.jpg" alt="Desserts" />
              <div className="category-info">
                <h3>Desserts</h3>
                <p>
            ...
            <div className="category-card">
              <img src="/TasteOfHome/beverages.jpg" alt="Beverages" />
              <div className="category-info">
                <h3>Beverages</h3>
                <p>
        ...
        <section className="featured-categoreies">
          ...
          <div className="category-grid">
            ...
            >
              <img src="/TasteOfHome/traditional.jpg" alt="Traditional Food" />
            ...
            >
              <img src="/TasteOfHome/modern.jpg" alt="Modern Food" />
              <h3>Modern Food</h3>
              <p>
        ...
        <section className="featured-categoreies">
          <div className="category-grid" style={{ marginTop: "2rem" }}>
            ...
            >
              <img src="/TasteOfHome/veg.jpg" alt="Vegetarian" />
              <h3>Vegetarian</h3>
              <p>
            ...
            >
              <img src="/TasteOfHome/nonveg.jpg" alt="Non-Vegetarian" />
